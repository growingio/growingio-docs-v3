...
这部分需要在 [SDK 集成](../developer-manual/sdkintegrated/)时开启设置。
...
​[请参照文档正确配置 URL Scheme](https://docs.growingio.com/v3/developer-manual/sdkintegrated/ios-sdk/manunl-ios-sdk#urlscheme)，并检查确认和官网中的应用管理中的一致。
