...
SDK 端配置：[iOS 端](https://growingio.gitbook.io/docs/developer-manual/sdkintegrated/ios-sdk/auto-ios-sdk#7-deeplink-and-universal-link)、[Android 端​](https://growingio.gitbook.io/docs/developer-manual/sdkintegrated/android-sdk/auto-android-sdk#15-deep-link-hui-tiao-can-shu-huo-qu)​

### 1.2 GrowingIO 产品配置 <a id="12-growingio-chan-pin-pei-zhi"></a>

Universal Links 配置：[配置方法​](https://growingio.gitbook.io/docs/product-manual/growing/ads/advance/deeplink#universal-links-pei-zhi)​

App Links 配置：[配置方法](https://growingio.gitbook.io/docs/product-manual/growing/ads/advance/deeplink#applinks-pei-zhi)​
