...
对于不同平台类型的应用，GrowingIO 提供了多种识别方案，从而尽可能的实现对用户的唯一标识。访问用户在不同平台的标识请参考[访问用户模型文档](https://growingio.gitbook.io/docs/introduction/datamodel/usermodel#fang-wen-yong-hu)。
...
配置方式参考[用户变量](https://growingio.gitbook.io/docs/product-manual/datacenter/datamanage/variable/user)。
