...
在开始用户变量配置与定义之前，推荐您阅读[页面事件及变量](../../../introduction/datamodel/eventmodel/autotrack-event/page-events-and-properties.md)文档，了解 GrowingIO 如何标记页面。
...
* ​[小程序、小游戏以及内嵌页 SDK​](../../../developer-manual/sdkintegrated/mini-program-sdk/)
