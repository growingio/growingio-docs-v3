...
**复合指标制作请看**[**自定义指标管理**](../product-manual-old/datacenter/datamanage/complex.md)**。**
...
**相关维度：** UTM 参数现在有，广告来源（utm\_source），广告媒介（utm\_medium ），广告关键字（utm\_term ），广告内容（utm\_content ）。您可以参考[UTM参数使用指南](../product-manual-old/growing/ads/info/utm-use.md)去配置 UTM 渠道追踪。我们建议你可以使用[广告监测](../product-manual-old/growing/ads/)功能。
