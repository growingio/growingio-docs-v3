...
**埋点事件配置方式请参考**[**埋点事件管理**](../../../product-manual/data-center/shu-ju-guan-li/manual.md)**。**

**事件级变量配置方式请参考**[**事件变量**](../../../product-manual/data-center/shu-ju-guan-li/event.md)**。**
...
* App及小程序可以使用数据校验功能校验进行[数据校验](../../../product-manual/data-center/shu-ju-xiao-yan/datacheck.md)。
{% endhint %}
